...
class SHA256TimeHandshake(Handshake):
    def __init__(self, secret_key: bytes, time_window: int = None, timeout: float = 5.0):
        assert isinstance(secret_key, bytes) and secret_key
        self.secret_key = secret_key
        self.time_window = time_window or 1
    ...
    def get_hashes(self) -> List[str]:
        ...
        return [
            ...
            for i in range(-self.time_window, self.time_window + 1)
        ]
